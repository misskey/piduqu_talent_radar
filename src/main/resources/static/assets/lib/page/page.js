...
define(function(){
    ...
    page.prototype = {
        ...
        generPageHtml : function(config){
            var enforceInit = config.enforceInit;
            if(enforceInit || !this.inited){
                this.init(config,enforceInit);
            }
            ...
            //点击事件
            this.initDomListener($("#"+this.pagerid));
        },
        //分页按钮控件初始化
        init : function(config, enforceInit){
        ...
        initDomListener: function(pNode){
            var me = this;
            pNode.find(".page-btn").on("click", function(){
                me._clickHandler(parseInt($(this).attr("page")));
            })
